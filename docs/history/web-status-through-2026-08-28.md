# Web product status — historical record

This records earlier work only. Instructions, blockers, "current" claims, and
mission-progression prerequisites below are superseded by
[the active roadmap](../web-roadmap.md) and [current status](../web-status.md).
Nothing here was rerun for the 2026-08-31 cleanup.
...
## Historical roadmap pass — 2026-08-28
