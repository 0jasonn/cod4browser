...
- Sound alias lists and their SndCurve/LoadedSound/SpeakerMap dependencies
- XAnimParts
...
Owned `code_post_gfx.ff` reaches asset 1200, type 8
`ASSET_TYPE_SOUND_CURVE`, at block 4 offset 176300. The exact next generated
closure begins with `Load_SndCurvePtr`; it is not implemented in this slice.
