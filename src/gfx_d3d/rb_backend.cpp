...
int R_TextSceneTime() { return gfxCmdBufSourceState.sceneDef.time; }
...
void __cdecl R_TextDrawQuad(
    ...
    uint32_t color)
{
    RB_DrawStretchPicRotate(material, x, y, w, h, s0, t0, s1, t1, sinAngle, cosAngle, color, GFX_PRIM_STATS_HUD);
}
