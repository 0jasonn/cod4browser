...
// Canonical KisakCOD/IW3 gameplay-facing weapon asset structure. This header
// intentionally keeps renderer, sound implementation, and XAnim runtime
// definitions out of the database loader's include graph.
struct XModel;
struct FxEffectDef;
...
enum WeapAccuracyType : std::int32_t
{
...
{                                       // ...
    ...
    std::uint16_t hideTags[8];
    std::uint16_t notetrackSoundMapKeys[16];
    std::uint16_t notetrackSoundMapValues[16];
    int playerAnimType;
    weapType_t weapType;
...
static_assert(sizeof(void *) != 4u || sizeof(WeaponDef) == 2168u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, szXAnims) == 80u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, viewFlashEffect) == 332u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, bounceSound) == 520u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, worldModel) == 700u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, overlayMaterial) == 1072u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, projectileModel) == 1412u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, accuracyGraphName) == 1900u);
static_assert(sizeof(void *) != 4u || offsetof(WeaponDef, szUseHintString) == 2012u);
