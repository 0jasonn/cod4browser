...
EM_JS(void, DispatchFrameProfile,
    (std::uint32_t pumpTick, std::uint32_t contextGeneration,
     ...
     double sceneModelBuildMs, double sceneCommandAppendMs,
     ...
     double dobjGeometryMs, double rendererFrontendMs,
        ...
        globalThis.dispatchEvent(new CustomEvent("kisakcod:frame-profile", {
            detail: {
                ...
                cpu: {
                    ...
                    dobjSkinningMs, dobjGeometryMs, rendererFrontendMs, soundMs,
...
void WebFrameProfile_EndPump(bool gameplayFrame, bool rendererSubmitted)
{
    ...
    DispatchFrameProfile(
        ...
        s.sceneEffectsPrepareMs, s.sceneModelBuildMs,
        ...
        s.dobjGeometryMs, s.rendererFrontendMs, s.soundMs, s.rendererBackendMs, s.totalMs,
