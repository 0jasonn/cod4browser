...
EM_JS(void, DispatchFrameProfile,
    (std::uint32_t pumpTick, std::uint32_t contextGeneration,
     ...
     double cgameFrameMs, double sceneBuildMs,
     double sceneSetupMs, double sceneAssemblyMs, double sceneImageResolveMs,
     double sceneDynamicSubmitMs, double sceneCameraVisibilityMs,
     double sceneViewSubmitMs, double sceneEffectsPrepareMs,
     double sceneModelBuildMs, double sceneBrushBuildMs, double sceneCommandAppendMs,
     double sceneBrushRemapMs, double sceneBrushGeometryMs,
     double sceneBrushMaterialMs, double sceneBrushAppendMs,
     double sceneCloudAppendMs, double dynamicCopyMs,
     double dynamicGeometryUploadMs, double dynamicTextureUploadMs,
     double dynamicPublishMs, double commandGeometryCheckMs,
     double commandGeometryCopyMs, double commandBatchCopyMs, double dobjBuildMs,
     double dobjPoseMs, double dobjLightingMs, double dobjSkinningMs,
     double dobjMatrixMs, double dobjWeightedSkinningMs,
     double dobjRigidSkinningMs,
     double dobjGeometryMs, double dobjVertexEmitMs, double dobjIndexEmitMs, double rendererFrontendMs,
     double soundMs, double rendererBackendMs, double totalMs,
     double rendererSetupMs, double lodMs, double sunShadowPrepareMs,
     double sunShadowDrawMs, double sunShadowWorldMs,
     double sunShadowStaticModelsMs, double sunShadowDynamicModelsMs,
     double spotShadowPrepareMs,
     double spotShadowDrawMs, double spotShadowWorldMs,
     double spotShadowStaticModelsMs, double spotShadowDynamicModelsMs,
     double skyMs, double worldMs,
     double staticModelsMs, double dynamicModelsMs,
     double dynamicModelProjectionMs, double dynamicModelMaterialMs,
     double dynamicModelParametersMs, double dynamicModelTexturesMs,
     double dynamicModelDrawMs, double fxModelsMs,
     ...
     double dynamicBatchesDrawn, double dynamicProjectionUpdates,
     double dynamicMaterialUpdates, double dynamicFeatureUpdates, double fxModelBatchesDrawn,
        ...
        globalThis.dispatchEvent(new CustomEvent("kisakcod:frame-profile", {
            detail: {
                ...
                cpu: {
                    ...
                    sceneBuildMs, sceneSetupMs, sceneAssemblyMs,
                    sceneImageResolveMs, sceneDynamicSubmitMs,
                    sceneCameraVisibilityMs, sceneViewSubmitMs,
                    sceneEffectsPrepareMs, sceneModelBuildMs, sceneBrushBuildMs,
                    sceneBrushRemapMs, sceneBrushGeometryMs,
                    sceneBrushMaterialMs, sceneBrushAppendMs,
                    sceneCommandAppendMs, sceneCloudAppendMs,
                    dynamicCopyMs, dynamicGeometryUploadMs,
                    dynamicTextureUploadMs, dynamicPublishMs,
                    commandGeometryCheckMs, commandGeometryCopyMs, commandBatchCopyMs,
                    dobjBuildMs, dobjPoseMs, dobjLightingMs,
                    dobjSkinningMs, dobjMatrixMs, dobjWeightedSkinningMs,
                    dobjRigidSkinningMs, dobjGeometryMs, dobjVertexEmitMs,
                    dobjIndexEmitMs, rendererFrontendMs, soundMs,
                    rendererBackendMs, totalMs
                },
                renderer: {
                    setupMs: rendererSetupMs, lodMs, sunShadowPrepareMs,
                    sunShadowDrawMs, sunShadowWorldMs,
                    sunShadowStaticModelsMs, sunShadowDynamicModelsMs,
                    spotShadowPrepareMs, spotShadowDrawMs,
                    spotShadowWorldMs, spotShadowStaticModelsMs,
                    spotShadowDynamicModelsMs,
                    skyMs, worldMs, staticModelsMs,
                    dynamicModelsMs, dynamicModelProjectionMs, dynamicModelMaterialMs,
                ...
                counters: {
                    ...
                    dynamicBatchesDrawn, dynamicProjectionUpdates,
                    dynamicMaterialUpdates, dynamicFeatureUpdates, fxModelBatchesDrawn,
...
void WebFrameProfile_EndPump(bool gameplayFrame, bool rendererSubmitted)
{
    ...
    DispatchFrameProfile(
        ...
        s.sceneSetupMs, s.sceneAssemblyMs, s.sceneImageResolveMs,
        s.sceneDynamicSubmitMs, s.sceneCameraVisibilityMs, s.sceneViewSubmitMs,
        s.sceneEffectsPrepareMs, s.sceneModelBuildMs, s.sceneBrushBuildMs,
        s.sceneCommandAppendMs,
        s.sceneBrushRemapMs, s.sceneBrushGeometryMs,
        s.sceneBrushMaterialMs, s.sceneBrushAppendMs, s.sceneCloudAppendMs,
        s.dynamicCopyMs, s.dynamicGeometryUploadMs,
        s.dynamicTextureUploadMs, s.dynamicPublishMs,
        s.commandGeometryCheckMs, s.commandGeometryCopyMs, s.commandBatchCopyMs,
        s.dobjBuildMs, s.dobjPoseMs, s.dobjLightingMs, s.dobjSkinningMs,
        s.dobjMatrixMs, s.dobjWeightedSkinningMs, s.dobjRigidSkinningMs,
        s.dobjGeometryMs, s.dobjVertexEmitMs, s.dobjIndexEmitMs,
        s.rendererFrontendMs, s.soundMs, s.rendererBackendMs, s.totalMs,
        s.rendererSetupMs, s.lodMs, s.sunShadowPrepareMs,
        s.sunShadowDrawMs, s.sunShadowWorldMs, s.sunShadowStaticModelsMs,
        s.sunShadowDynamicModelsMs, s.spotShadowPrepareMs,
        s.spotShadowDrawMs, s.spotShadowWorldMs,
        s.spotShadowStaticModelsMs, s.spotShadowDynamicModelsMs,
        s.skyMs, s.worldMs, s.staticModelsMs, s.dynamicModelsMs,
        s.dynamicModelProjectionMs, s.dynamicModelMaterialMs, s.dynamicModelParametersMs,
        s.dynamicModelTexturesMs, s.dynamicModelDrawMs,
        ...
        static_cast<double>(s.dynamicProjectionUpdates),
        static_cast<double>(s.dynamicMaterialUpdates),
        static_cast<double>(s.dynamicFeatureUpdates),
