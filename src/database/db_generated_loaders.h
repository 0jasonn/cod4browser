...
extern GameWorldSp *varGameWorldSp;
extern GameWorldSp **varGameWorldSpPtr;
extern MapEnts *varMapEnts;
extern MapEnts **varMapEntsPtr;
extern clipMap_t *varclipMap_t;
extern clipMap_t **varclipMap_ptr;
