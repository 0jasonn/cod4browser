...
- Keep canonical game, player, weapon, entity, world, script, renderer-frontend, and asset identity state in Kisak code; never duplicate those systems in JavaScript.
- Do not restore the retired Gate 2 census, parallel retail parsers, synthetic world/proof infrastructure, or other browser-owned engine substitutes.
