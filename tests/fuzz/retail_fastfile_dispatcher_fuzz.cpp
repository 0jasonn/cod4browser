...
kisak::fastfile::RetailCensusLimits FuzzLimits() noexcept
{
    ...
    limits.maxGfxWorlds = 2u;
    limits.maxGfxWorldArrayElements = 16u * 1024u;
    limits.maxGfxWorldVertices = 16u * 1024u;
    limits.maxGfxWorldIndices = 64u * 1024u;
    limits.maxGfxWorldSurfaces = 16u * 1024u;
    limits.maxGfxWorldCells = 1024u;
    limits.maxGfxWorldLightmaps = 1024u;
    limits.maxGfxWorldStaticModels = 16u * 1024u;
    limits.maxGfxWorldMaterialMemory = 16u * 1024u;
    limits.maxGfxWorldPayloadBytes = 512u * 1024u;
    limits.maxRetainedGfxWorldBytes = 512u * 1024u;
