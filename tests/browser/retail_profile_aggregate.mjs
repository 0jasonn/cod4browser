export const CPU_PROFILE_FIELDS = [
    ...
    "dobjBuildMs", "dobjPoseMs", "dobjLightingMs", "dobjSkinningMs",
...
export const RENDERER_PROFILE_FIELDS = [
    ...
    "spotShadowPrepareMs", "spotShadowDrawMs", "spotShadowWorldMs",
    "spotShadowStaticModelsMs", "spotShadowDynamicModelsMs",
    "skyMs", "worldMs",
